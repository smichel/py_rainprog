...
\centering
	...
	\node [proc,densely dotted,below of=b0,yshift=-1cm] (b1) {Gridding and Interpolation};
...
The 'edge length of the patches for DWD and PATTERN' is set to 12000\,m and 2000\,m. This results in patch sizes of 12000\,m x 12000\,m for DWD and 2000\,m x 2000\,m for PATTERN.
\begin{table}[ht]
	\centering
