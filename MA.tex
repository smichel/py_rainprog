...
\savebox{\mybox}{%
	...
	\addplot+[ybar interval,mark=no] plot coordinates { (0, 0.3) (0.1, 0.1) (0.2, 0.05) (0.3, 0.08) (0.4, 0.07) (0.5, 0.1) (0.6, 0.08) (0.7, 0.02) (0.8, 0.05) (0.9, 0.2) (1,0)};
	\end{axis}
\end{tikzpicture}
}
...
\begin{figure}[!htbp]
	...
	\draw [->] (0.2,0.6)--(0.36,0.36);
	\draw (axis cs: 0.75,0.25)node{\usebox{\mybox}};
	\end{axis}
	\end{tikzpicture}
	\caption[Reliability Diagram]{Reliability diagram for example data. The dots show the observed relative frequency of the occurrence of precipitation. The dotted line shows a perfect forecast. Figure created after \cite{Wilks}.}
