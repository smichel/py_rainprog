...
\begin{equation}
	...
	\label{eq:trans}
\end{equation}
The Cartesian distances to the radar are then transformed to Cartesian coordinates within the Transverse Mercator projection \footnote{For the Transverse Mercator projection the 'Geospatial Data Abstraction Library' (GDAL) and the python module 'osgeo' was used \citep{Warmerdam}.}.
\begin{equation}
