...
Hier noch über die calibration curve mit good resoultion in figure d.
...
\begin{figure}[!htbp]
	...
	\node [dot=A] at (0,0) {};
	\node [dot=B] at (0.03,0.4) {};
	\node [dot=C] at (0.06,0.6) {};
	\node [dot=D] at (0.09,0.8) {};
	\node [dot=E] at (0.15,0.85) {};
	\node [dot=F] at (0.3,0.89) {};
	\node [dot=G] at (0.45,0.93) {};
	\node [dot=H] at (0.7,0.96) {};
	\node [dot=I] at (1,1) {};
	...
	\node [dot=BE] at (0.3,0.67) {};
	\node [dot=BF] at (0.52,0.75) {};	
	\node [dot=BG] at (0.7,0.85) {};	
	\node [dot=BH] at (1,1) {};	
	\node [dot=BI] at (0,0) {};	
	\draw[fill=black!10,fill opacity = 0.8] (0,0) -- (0.1,0.25) -- (0.16,0.4) -- (0.24,0.6) -- (0.3,0.67) -- (0.52,0.75) -- (0.7,0.85) -- (1,1) -- (1,0);
	%\draw (BA)--(BB)--(BC)--(BD)--(BE)--(BF)--(BG)--(BH);	
	\draw[dashed] (0,0) -- (1,1);
	\node [dot=dummy] at (1,0) {};
	\node [coordinate] at (0.7,0.3) {ROC Area};
	\end{axis}
	\end{tikzpicture}
