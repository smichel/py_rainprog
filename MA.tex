...
The Deutscher Wetterdienst (DWD) operates a radar network which covers Germany (Figure \ref{fig:radarnetwork}). From this network the radar Boostedt 

\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{dwdradarnetwork.png}
