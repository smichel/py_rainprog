...
\begin{figure}[h]
	\centering
	\begin{tikzpicture}[
	declare function={mu1=3.40909;},
	declare function={mu2=-1.9545;},
	declare function={sigma1=3.82178554;},
	declare function={sigma2=0.53510949;},
	declare function={sigma12=0.7623108;},
	declare function={rho=0.3727546;},
...
%	declare function={bivar(\ma,\sa,\mb,\sb,\corr)= 1/(2*pi*\sa*\sb) * exp( -((x-\ma)^2/(2*\sa^2)) - ((y-\mb)^2/(2*\sb^2)));}]
	...
	\draw [black!80] (axis cs:-8,0,0) -- (axis cs:14,0,0);
	\draw [black!80] (axis cs:0,-6,0) -- (axis cs:0,2,0);
	\draw [blue!50] (axis cs:3.41,-6,0) -- (axis cs:3.41,2,0);
	\draw [blue!50] (axis cs:-8,-1.95,0) -- (axis cs:14,-1.95,0);
	\draw [blue!50] (axis cs:3.41,-1.95,0) -- (axis cs:3.41,-1.95,0.08);
	\node at (axis cs:3.41,-1.95,0) [fill=blue,circle,scale=0.3] {};
	\node at (axis cs:3.41,-1.95,0.08) [fill=blue,circle,scale=0.3,pin=15:{$P(\mu_x,\mu_y)$}] {};
	%\node at (axis cs:1.5,3,0.0) [pin=-15:$P(y)$] {};
	\end{axis}
	\end{tikzpicture}
	\caption{Bivariate Gaussian density, with $\mu_x=3.41$, $\mu_y=-1.95$, $\sigma_x = 3.82$, $\sigma_y=0.54$ and $\rho = 0.37$}
	\label{fig:2dgauss}
\end{figure}
