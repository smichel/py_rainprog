...
\begin{figure}[!htbp]
	...
	\draw[thick] (0,5) .. controls (0.75,4.5) and (1.25,1) .. (2.1,0.5);
	\node at (3.5,4.5) [text width=5cm] {Extrapolation of the current \\atmospheric state using radar observations};
	\draw[thick] (0,2.3) .. controls (1.4,2.8) and (2.8,1.2) .. (3.5,1.1);
	\draw[thick] (1,0.2) .. controls (3.5,1.5) .. (6,0.6);
	\end{axis}
	\end{tikzpicture}
	\caption{.}
	\label{fig:prognosisScores}
\end{figure}
